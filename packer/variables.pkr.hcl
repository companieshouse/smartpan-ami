...
variable "aws_source_ami_filter_name" {
  type        = string
  default     = "al2023-ami-2023.0.*-x86_64"
...
variable "resource_bucket_smartpan_prefix" {
  type        = string
  description = "The object prefix for SmartPAN packages within the S3 resources bucket"
}
